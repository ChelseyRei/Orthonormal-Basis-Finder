...
BUTTON_CALCULATE = '!bg-violet-500 hover:bg-violet-600 text-white flex-grow font-bold shadow-md transition-colors'
BUTTON_RESET = '!bg-violet-500 hover:bg-violet-600 text-white w-32 font-medium rounded shadow-sm'
BUTTON_ROW = 'w-full gap-4 mt-4'


# Result display styles
RESULT_BOX = (
    'min-w-[7rem] max-w-[15rem] w-auto min-h-[3rem] p-4 '
    'flex items-center justify-center '
    'rounded-xl shadow-sm bg-violet-50 hover:bg-violet-100'
    'hover:shadow-md transition-all'
)
RESULT_BOX_LABEL = 'text-sm break-all text-center leading-tight font-medium text-slate-700'
